...
<title>ALEX_FITNESS40 | Cambio real de forma natural</title>
<style>
body{margin:0;background:#080808;color:#fff;font-family:Arial;text-align:center}
h1{color:#D4AF37;font-size:38px} .tag{color:#7CFF7C;font-size:26px;font-style:italic}
.btn{background:#25D366;color:#000;padding:18px 35px;border-radius:50px;font-weight:900;font-size:20px;text-decoration:none;display:inline-block;margin:20px}
.box{background:#111;border:1px solid #222;padding:20px;border-radius:15px;max-width:700px;margin:15px auto;text-align:left}
h2{color:#D4AF37;border-left:4px solid #D4AF37;padding-left:10px}
</style></head><body>
<img src="logo.jpg" style="width:170px;border-radius:50%;border:3px solid #D4AF37;margin-top:30px">
